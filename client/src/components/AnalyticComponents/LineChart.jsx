...
const LineChart = () => {
  ...
  const options = useMemo(() => {
    return {
      ...
      annotations: {
        yaxis: [
          {
            y: series[0].data[series[0].data.length - 1][1] + (series[0].data[series[0].data.length - 1][1] * 0.02),
            borderColor: '#00E396',
            label: {
              borderColor: 'none',
              style: {
  ...
  return (
    <Box
      className="flex items-center justify-center text-primary p-3"
      sx={{
        color: theme.palette.mode === 'dark' ? "white!important" : "black!important",
      }}
    >
    <div id="chart" className='basis-full lg:basis-2/3 '>
